...
namespace Bearded.Photones.Input
{
    partial class InputManager
    {
        ...
        public bool AllKeysPressed(params Key[] keys) => keys.All(IsKeyPressed);
        public bool AllKeysHit(params Key[] keys) => keys.All(IsKeyHit);
        public bool AllKeysReleased(params Key[] keys) => keys.All(IsKeyReleased);

        public bool AnyKeysPressed(params Key[] keys) => keys.Any(IsKeyPressed);
        public bool AnyKeysHit(params Key[] keys) => keys.Any(IsKeyHit);
        public bool AnyKeysReleased(params Key[] keys) => keys.Any(IsKeyReleased);
